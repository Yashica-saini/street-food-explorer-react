...
import usersData from "../data/users.json"; // adjust path if needed
import "./Signup.css";
...
function Signup() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!usernameRegex.test(username)) {
      alert(
        "Username must be 8-14 characters and contain only letters and numbers."
      );
      return;
    }
    ...
    // ✅ Check if email already exists in JSON
    ...
    // ✅ Signup successful (cannot save in JSON, just simulate)
